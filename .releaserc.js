...
// `${...}` placeholders below are expanded by semantic-release, not by JS
// (only backticks interpolate in JS) -- the two that trip xo's
// no-template-curly-in-string false-positive carry an inline disable.
